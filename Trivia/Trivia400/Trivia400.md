...
Bu resimi Google' da arattýðýnýz zaman karþýnýza buna benzer resimlerin çýktýðýný göreceksiniz.Kýsa bir araþtýrma sonucunda karþýmýza 'Cartão perfurado' yani delikli kart çýkmýþtý.Neydi peki bu delikli kart?
Bu kartlar ilk üretilen bilgisayarlarýn bellek görevini üstlenmesi için geliþtirilmiþtir.
Bizim bu kart üzerinde kodlanmýþ veriyi çözmemiz gerekiyordu.Bunu tek tek aþaðýdaki þablona bakarak çýkarabilirsiniz.Bu þablonu kolay bir þekilde Google' da bulabilirsiniz.

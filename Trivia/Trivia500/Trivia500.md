...
![alt tag](https://github.com/muratozclk/HWARS-CTF/blob/master/Trivia/Image/notthateasy.png?raw=true)

Daha sonra binary kodunda ipucu olabileceðini düþündük. Fakat burdanda ipucu yakalayamadýk.

![alt tag](https://github.com/muratozclk/HWARS-CTF/blob/master/Trivia/Image/binarykod.png?raw=true)

Labirent üzerindeki harfleri araþtýrmaya baþladýk. Uzun süre takým arkadaþlarýmýzla bu nokta üzerinde araþtýrma yaptýk.
Bu harflerin matematik sembollerini ifade edebileciðini düþündük fakat burdanda birþey çýkmadý.
Eski roma alfabesi ile iliþkili olabileceði fikri geldi aklýmýza.

![alt tag](https://github.com/muratozclk/HWARS-CTF/blob/master/Trivia/Image/romaalp.png?raw=true)

Uzun süre yaptýðýmýz denemeler sonucunda burdanda herhangi bir sonuca ulaþamadýk.
